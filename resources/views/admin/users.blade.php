...
<div id="section-users" class="section-content">
    <div class="animate-in"><h5 class="fw-bold mb-0">User Management</h5><p class="text-muted mb-3" style="font-size: 0.85rem;">Manage team members</p>
        <div class="card chart-card"><div class="card-body p-0">
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0">
                    <thead><tr><th style="font-size: 0.7rem;">User</th><th style="font-size: 0.7rem;">Role</th><th style="font-size: 0.7rem;">Status</th><th style="font-size: 0.7rem;">Actions</th></tr></thead>
                    <tbody>
